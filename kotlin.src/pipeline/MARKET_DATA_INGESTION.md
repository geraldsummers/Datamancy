...
java -jar build/libs/pipeline-all.jar \
...
services:
  market-data-ingestion:
    image: datamancy/pipeline:latest
...
See `kotlin.src/test-runner` for full E2E tests that verify:
...
```
**Solution:** Reduce batch size or increase heap: `java -Xmx2G -jar pipeline.jar`
