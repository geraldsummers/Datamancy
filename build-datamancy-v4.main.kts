...
fun generateTestRunnersCompose(
    ...
    val content = buildString {
        ...
        appendLine("    TEST_RUNNER_OAUTH_SECRET: \${TEST_RUNNER_OAUTH_SECRET}")
        ...
        appendLine("    FORGEJO_PASSWORD: \${STACK_ADMIN_PASSWORD}")
        appendLine("    PLANKA_EMAIL: \${STACK_ADMIN_EMAIL}")
        ...
        appendLine("    ISOLATED_DOCKER_VM_DOCKER_HOST: tcp://docker-vm-socket-proxy:2375")
        appendLine("    DOCKER_HOST_ISOLATED: tcp://docker-vm-socket-proxy:2375")
