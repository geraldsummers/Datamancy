...
FILE_SERVER_ROOT = "https://seafile.project-saturn.com/seafhttp"

# Email configuration (uses Mailu)
EMAIL_USE_TLS = True
EMAIL_HOST = 'smtp.project-saturn.com'
EMAIL_HOST_USER = 'seafile@project-saturn.com'
...
ONLYOFFICE_APIJS_URL = 'https://onlyoffice.project-saturn.com/web-apps/apps/api/documents/api.js'
