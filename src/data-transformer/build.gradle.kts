...
dependencies {
    ...
    // ClickHouse JDBC with LZ4 compression support (for source adapters only)
...
application {
    mainClass.set("org.datamancy.datatransformer.MainKt")
}

tasks.shadowJar {
    archiveBaseName.set("data-transformer")
}
