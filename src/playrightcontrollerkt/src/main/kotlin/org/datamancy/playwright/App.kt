            ...
            post("/function") {
                try {
                    ...
                    val code: String = when {
                        ...
                        contentType.match(ContentType.Text.Plain) || contentType.match(ContentType("application", "javascript")) -> raw
                        else -> {
                    ...
                    val usernameFillRegex = Regex("fill\(['\"]([^'\"]*username[^'\"]*)['\"],\s*['\"]([^'\"]+)['\"]", RegexOption.IGNORE_CASE)
                    val passwordFillRegex = Regex("fill\(['\"]([^'\"]*password[^'\"]*)['\"],\s*['\"]([^'\"]+)['\"]", RegexOption.IGNORE_CASE)
