<?php
// Nextcloud OIDC (OpenID Connect) configuration for Authelia
// Requires the "OpenID Connect Login" app to be installed/enabled in Nextcloud.
$CONFIG = array(
  // OIDC provider
  'oidc_login_provider_url' => 'https://id.lab.localhost',
  'oidc_login_client_id' => 'nextcloud',
  'oidc_login_client_secret' => getenv('OIDC_NEXTCLOUD_CLIENT_SECRET') ?: 'nextcloud_oidc_secret_change_me',
  'oidc_login_redirect_url' => 'https://nextcloud.lab.localhost/apps/oidc_login/oidc',
