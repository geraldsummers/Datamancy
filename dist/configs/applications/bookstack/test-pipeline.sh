...
echo
echo "Next steps:"
echo "1. BookStack UI: https://bookstack.datamancy.net"
echo "2. Data Fetcher: https://data-fetcher.datamancy.net"
echo "3. Search Indexer: https://search-indexer.datamancy.net"
echo "4. Search Gateway: https://search.datamancy.net"
