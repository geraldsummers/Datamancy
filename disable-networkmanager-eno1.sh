...
# Disable NetworkManager on eno1 (let systemd-networkd handle it)
# This fixes the dual IP conflict where NetworkManager and systemd-networkd fight
...
# Delete any NetworkManager connections for eno1
...
# Create NetworkManager config to ignore eno1
