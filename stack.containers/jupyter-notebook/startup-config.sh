...
write_notebook(
    ...
    [
        ...
        code_cell(
            ...
            "exchange = os.getenv('DATAMANCY_FORWARD_TEST_EXCHANGE', 'hyperliquid_mainnet').strip() or 'hyperliquid_mainnet'\n"
        ...
        code_cell(
            ...
            "                'metadata': metadata\n"
            "            })\n"
            "    print(f'Persisted {len(rows)} forward-test rows into execution/drift telemetry tables for {exchange}/{symbol}.')\n"
            "else:\n"
