...
data class CrossSectionalPolicy(
    ...
    val barMinutes: Int = 60,
    val lookbackHours: Int = 1_080,
    val forwardHours: Int = 72,
    val betaLookbackBars: Int = 168,
    val trendLookbackBars: Int = 24,
    val trendSlowBars: Int = 96,
    val reversionLookbackBars: Int = 12,
    val trendHoldBars: Int = 24,
    val reversionHoldBars: Int = 8,
    val topPerSide: Int = 1,
    val notionalUsd: Double = 5_000.0,
    val maxSymbols: Int = 0,
    val discoveryMaxSymbols: Int = 0,
    val minBars: Int = 360,
    val trendEntryScore: Double = 1.05,
    val reversionZEntry: Double = 2.15,
    ...
    val calibrationLookbackHours: Int = 720,
    ...
    val trendCooldownBars: Int = 8,
    val reversionCooldownBars: Int = 4,
...
data class CrossSectionalSearchPolicy(
    ...
    val lookbackHours: List<Int> = listOf(120, 240, 360, 720, 1_080, 1_440, 2_160),
    ...
    val maxSymbols: List<Int> = listOf(0, 24, 48, 72, 120),
    val discoveryMaxSymbols: List<Int> = listOf(0, 96, 192, 384),
    ...
    val calibrationLookbackHours: List<Int> = listOf(240, 360, 720, 1_080),
