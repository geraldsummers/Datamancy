...
data class ArchiveImportPlanRequest(
    val exchange: String = "hyperliquid_mainnet",
    val startDate: String,
    val endDate: String,
    val channels: List<String> = listOf("trade", "candle_1m", "funding", "open_interest", "orderbook_l2")
)

data class ArchiveImportWindow(
    val month: String,
    val exchange: String,
