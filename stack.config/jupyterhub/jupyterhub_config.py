...
c.Spawner.environment = {
    ...
    'DATAMANCY_FORWARD_TEST_LOOKBACK': os.environ.get('DATAMANCY_FORWARD_TEST_LOOKBACK', '12 hours'),
    'DATAMANCY_FORWARD_TEST_EXECUTION_MODE': os.environ.get('DATAMANCY_FORWARD_TEST_EXECUTION_MODE', 'forward_paper'),
    'DATAMANCY_FORWARD_TEST_MARKET_DATA_MODE': os.environ.get('DATAMANCY_FORWARD_TEST_MARKET_DATA_MODE', 'mainnet_live'),
    'DATAMANCY_FORWARD_TEST_PERSIST': os.environ.get('DATAMANCY_FORWARD_TEST_PERSIST', 'true'),
    'DATAMANCY_FORWARD_TEST_MAX_ROWS': os.environ.get('DATAMANCY_FORWARD_TEST_MAX_ROWS', '500'),
